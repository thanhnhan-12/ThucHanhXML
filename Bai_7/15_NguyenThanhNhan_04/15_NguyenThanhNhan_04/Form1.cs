...
namespace _15_NguyenThanhNhan_04
{
    public partial class Form1 : Form
    {
        ...
        void chuyendoiItems()
        {
            ...
            new XElement("head",
            new XElement("style", "table{border:solid 1px red;border - collapse: collapse}",
            ...
            // Hãy thêm nhiều style nữa ở đây.
             ...
             new XElement("table",
             new XElement("tr",
             new XElement("td", "Icode"),
             new XElement("td", "IName"),
             new XElement("td", "rate")
            ...
            el.Attribute("rate").Value) // End of td …
            ) // End of tr
             ) // End of table
             ) // End of body
             ); // End of html
        ...
        void chuyendoiCustomer()
        {
            ...
            xItem = XDocument.Load(pathCustomer);

            var xI = xItem.Descendants("customer");
            var html = new XElement("html", // Tạo cây HTML trong bộ nhớ
            new XElement("head",
            new XElement("style", "table{border:solid 1px red;border - collapse: collapse}", "td{border:solid 1px silver;}"
             ...
             new XElement("body",
                 ...
                 new XElement("table",
                 new XElement("tr",
                     new XElement("td", "Ccode"),
                     new XElement("td", "CName"),
                     new XElement("td", "address")
             ), // End of tr of table header
            from el in xI
            select new XElement("tr",
                new XElement("td", el.Attribute("ccode").Value),
                new XElement("td", el.Attribute("cname").Value),
                new XElement("td", el.Attribute("address").Value) // End of td …
            ) // End of tr
             ) // End of table
             ) // End of body
             ); // End of html
